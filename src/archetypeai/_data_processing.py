...
class DataProcessingApi(ApiBase):
    ...
    def create_job(self, job_config: dict) -> dict:
        ...
        api_endpoint = os.path.join(self.api_endpoint, "data_processing")
    ...
    def get_info(self) -> dict:
        ...
        api_endpoint = os.path.join(self.api_endpoint, "data_processing/info")
    ...
    def get_metadata(self, shard_index: int = -1, max_items_per_shard: int = -1) -> dict:
        ...
        """
        api_endpoint = os.path.join(self.api_endpoint, "data_processing/metadata")
